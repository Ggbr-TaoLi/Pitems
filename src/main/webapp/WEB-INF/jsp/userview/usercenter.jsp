	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="col-md-12">
					<h1>
						<a name="section4">猜你喜欢(基于用户的协同过滤)</a>
					</h1>
					<hr />
 ...
 <div id="evaData" style="width:600px;padding-top:15px;display:none;">
	...
	<script type="text/javascript">
		...
		function showRecentView() {
			$.ajax({
				type : "post",
				url : "recommender/recommendGoodsBasedUser",
				dataType : "json",
				success : function(arr) {
					var str = "";
					if (arr == null ||arr=="") {
					 ...
					 str = "<div style='padding-left:0px;margin-left:-40px' class='span16'><ul>";
					for (var i = 0; i < arr.length; i++) {
						if ((i + 1) % 4 != 0) {
							str = str
									+ "<li><a href='goods/detail?goodsId="
									+ arr[i].recommendId
									+ "'>"
									+ "<img style='margin-bottom:2px;margin-top:10px;' src='upload/"+arr[i].recommendImg+"' /><p class='goods-title'>"
									+ arr[i].recommendName
									+ "</p>"
									+ "<p class='goods-desc'>"
									+ arr[i].recommendDesc
									+ "</p></a><p><span class='newprice'>"
									+ arr[i].recommendPrice
									+ "元</span>&nbsp;"
									+ "</p>"
									+ "<p class='goods-desc'>偏好值："
									+ arr[i].goodsValues
									+ "</p><button onclick='addToFavorite("
									+ arr[i].recommendId
				...
				$.ajax({
					...
					success:function(data){
						if(data=="success"){
							...
							layer.msg("支付失败！请重试！",{icon: 5, time: 2000});
						}
					}
				});
			});
